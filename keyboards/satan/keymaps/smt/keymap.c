...
[_DVORAK] = KEYMAP_ANSI(
   ...
   * |-----------------------------------------------------------|
   * |     |Hom| Up|End|   |   |   |   |   |   |Mut|BL-|BL+|BL   |
   * |-----------------------------------------------------------|
   * |      |Lft|Dwn|Rgt|   |   |Lft|Dwn| Up|Rgt|Vo+|Pg+|        |
   * |-----------------------------------------------------------|
   * |        |   |   |Prv|Ply|Nxt|   |   |   |Vo-|Pg-|          |
   * |-----------------------------------------------------------|
   * |    |    |    |                        |    |    |    |    |
...
[_LOWER] = KEYMAP_ANSI(
  ...
  _______,KC_HOME,KC_UP  ,KC_END ,_______,_______,_______,_______,_______,_______,KC_MUTE,BL_DEC ,BL_INC ,BL_TOGG, \
